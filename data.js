...
const PLACES = [
  // ── London ─────────────────────────────────────────────
  {
    ...
    note: "영국 바로크 건축의 대표작. 돔이 인상적.", photo: ""
  },
  {
  ...
  },
  {
    ...
    note: "내부 설비를 바깥으로 드러낸 하이테크 건축.", photo: ""
  },
  {
    name: "30 세인트 메리 액스(거킨)", nameEn: "30 St Mary Axe (The Gherkin)",
    city: "London", country: "UK", lat: 51.5145, lng: -0.0803,
    status: "toVisit", architect: "Norman Foster", year: 2003,
    note: "오이 모양의 친환경 고층 오피스.", photo: ""
  },
  {
    ...
    note: "아르데코 발전소를 복합공간으로 재생.", photo: ""
  },
  ...
  },
  {
    ...
    note: "구조와 설비를 외부에 드러낸 하이테크 미술관.", photo: ""
  },
  {
  ...
  // ── Barcelona ──────────────────────────────────────────
  {
    ...
    note: "100년 넘게 짓고 있는 가우디의 미완성 대성당.", photo: ""
  },
  {
  ...
  },
  {
    ...
    note: "근대 건축 'Less is more'의 원형.", photo: ""
  },
  ...
  // ── Bilbao ─────────────────────────────────────────────
  {
    ...
    note: "티타늄 곡면으로 도시를 되살린 미술관.", photo: ""
  },
  ...
  },
  {
    ...
    note: "무대를 가운데 둔 포도밭형 콘서트홀.", photo: ""
  },
  {
  ...
  // ── Rome ───────────────────────────────────────────────
  {
    ...
    note: "지름과 높이가 같은 고대 콘크리트 돔.", photo: ""
  },
  {
  ...
  // ── Rotterdam ──────────────────────────────────────────
  {
    ...
    note: "아치형 주거 안에 들어선 실내 시장.", photo: ""
  },
  {
    ...
    note: "45도로 기울인 정육면체 집합 주거.", photo: ""
  },
  ...
  // ── Vienna ─────────────────────────────────────────────
  {
    ...
    note: "직선을 거부한 색채 가득한 공공주택.", photo: ""
  },
  ...
  // ── Brussels ───────────────────────────────────────────
  {
    ...
    note: "철 결정 구조를 1650억 배 확대한 구조물.", photo: ""
  }
];
